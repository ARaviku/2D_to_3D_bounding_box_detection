...
def main():
    ...
    for model_weight in weight_list:
        ...
        # model = Model.Model(features=my_mobilenet.features, bins=2)
        ...
        dataset = Dataset('/content/drive/MyDrive/cv_project_pytorch_yolo/DEEPROB_FINAL_YOLO_PYTORCH/kitti/validation')
